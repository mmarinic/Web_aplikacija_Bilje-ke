...
def signup():
    '''
        App za registraciju novog korisnika
    '''
    form = SignUpForm()
    if form.validate_on_submit():
        username = request.form['username']
        ...
        if check:
            flash('Korisničko ime se već koristi!')
        else:
...
def custom_date(date):
    '''
        Pretvara datetime u prilagođeni format kao što je: Mar 01,2019 19:07:32
    '''
...
def profile_settings():
    '''
        App za dobivanje postavki profila za korisnika
    '''
...
def change_email():
    '''
        App za promjenu e-pošte korisnika
    '''
...
def change_password():
    '''
        App za promjenu lozinke korisnika
    '''
...
def background_process():
    '''
        App za rukovanje AJAX zahtjevima za pretraživanje bilješki
    '''
    try:
    ...
    def post(self):
        try:
            ...
            if user_id:
                ...
                return {'error': 'Ne možete pristupiti ovoj stranici, provjerite korisničko ime i zaporku'}
